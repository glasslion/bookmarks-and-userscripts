...
var detail = {
  ...
  replaceRcolumn: function(c) {
    ...
    search.href = 'https://www.google.com/#q=' + getCid(location.pathname, true)[0]+'+torrent';
...
function redirect404() {
  return
  if (window.location.href.indexOf('www.dmm.co.jp/mono/dvd/-/detail/') < 0) {
    return
  }
  var regex = /cid=(\w+)\//;
  var match = regex.exec(window.location.href);
  var newUrl = 'http://www.dmm.co.jp/digital/videoa/-/detail/=/cid='+match[1];
